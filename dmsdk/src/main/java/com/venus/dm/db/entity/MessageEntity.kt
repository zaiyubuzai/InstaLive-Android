...
open class MessageEntity {
    ...
    constructor(
        ...
        this.msgDisappearTT = msgDisappearTT
        this.read = read
        this.state = state
    ...
    class Payload {
        ...
        val status: Int? = null
        @SerializedName("message_uuid") val uuid: String? = null
        @SerializedName("target_uuid") val targetUUID: String? = null
        @SerializedName("content_me") val contentMe: String? = null
        @SerializedName("sender_portrait") val senderPortrait: String? = null
        @SerializedName("sender_name") val senderName: String? = null
        @SerializedName("thumbnail_url") val thumbnail: String? = null
        val amount: Int? = null
        val deeplink: String? = null
        val state: Int? = null
        @SerializedName("share_user_id") val shareUserId: String? = null
        @SerializedName("user_id") val userId: String? = null
        @SerializedName("target_msg") var targetMessage: TargetMessage? = null
        @SerializedName("live_id") val liveId: String? = null
        @SerializedName("show_type") val showType: Int = 0
        @SerializedName("render_type") val renderType: Int? = 1
        val level: Int = -1
        @SerializedName("gift_img") val giftImg: String? = null
        @SerializedName("gift_name") val giftName: String? = null
        @SerializedName("gift_id") val giftId: String? = null
        @SerializedName("user_info") val userInfo: GroupMember? = null
        val highlight: Int = 0
        @SerializedName("target_timetoken") var targetTimetoken: Long? = null
        companion object {
