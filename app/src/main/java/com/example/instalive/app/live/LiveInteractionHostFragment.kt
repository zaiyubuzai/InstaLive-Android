...
import com.fambase.venus.BuildConfig
import com.fambase.venus.MarsApp
import com.jeremyliao.liveeventbus.LiveEventBus
import com.lxj.xpopup.XPopup
import com.fambase.venus.api.StatusEvent
import com.fambase.venus.app.Constants
import com.fambase.venus.app.Constants.EVENT_BUS_KEY_LIVE_HOST_ACTIONS
import com.fambase.venus.app.FambasePreferences
import com.fambase.venus.app.RecentConversation
import com.fambase.venus.app.SessionPreferences
import com.fambase.venus.app.main.LiveMoreDialog
import com.fambase.venus.app.message.MessageBaseViewModel.Companion.ITRCT_TYPE_FLIP
import com.fambase.venus.app.message.MessageBaseViewModel.Companion.ITRCT_TYPE_LIVE_OFF
import com.fambase.venus.app.message.MessageBaseViewModel.Companion.ITRCT_TYPE_MAKEUP_OFF
import com.fambase.venus.app.message.MessageBaseViewModel.Companion.ITRCT_TYPE_MAKEUP_ON
import com.fambase.venus.app.videorecord.RecordActivity
import com.fambase.venus.databinding.FragmentLiveHostInteractionBinding
import com.fambase.venus.model.LiveStateInfo
import com.fambase.venus.model.event.LiveGiftEvent
import com.fambase.venus.model.event.LiveRaiseHandEvent
import com.fambase.venus.model.event.LiveWithCallEvent
import com.fambase.venus.utils.VenusNumberFormatter
import com.fambase.venus.utils.alphaClick
import kotlinx.android.synthetic.main.fragment_live_host_interaction.*
...
class LiveInteractionHostFragment :
    LiveInteractionBaseFragment<FragmentLiveHostInteractionBinding>() {
                    ...
                    LiveViewersHostDialog(
                        ...
                        cancelLiveWith = {
                            if (activity is RecordActivity) {
                                ...
                                (activity as LiveActivity).tryHangUpLiveWith(
                                    currentLiveWithUser?.userId ?: ""
                                )
                            }
                        })
...
//            }
    ...
    private fun startLiveWith() {
        ...
        XPopup.Builder(c)
            .isDestroyOnDismiss(true)
            .maxHeight(screenHeight - c.dip(300))
            .asCustom(
                GoLiveWithDialog(
                    c,
                    viewModel.roomId,
...
//        privateSwitch.setCompoundDrawables(end = if (data.privateInfo.checked) R.drawable.ic_live_private_on else R.drawable.ic_live_private_off)
    ...
    override fun getLayoutId(): Int {
        return R.layout.fragment_live_host_interaction
    }
}