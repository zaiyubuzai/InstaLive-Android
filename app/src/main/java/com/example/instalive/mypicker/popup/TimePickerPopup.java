package com.example.instalive.mypicker.popup;
...
import com.example.instalive.mypicker.view.WheelTime;
...
public class TimePickerPopup extends BottomPopupView {
    ...
    protected void applyDarkTheme() {
        ...
        btnConfirm.setTextColor(Color.parseColor("#007aff"));
        getPopupImplView().setBackground(XPopupUtils.createDrawable(Color.parseColor("#181d28"),
    ...
    private void initWheelTime(LinearLayout timePickerView) {
        ...
        wheelTime.setDividerType(WheelView.DividerType.WRAP);
    ...
    public TimePickerPopup setItemDividerWidth(int width){
