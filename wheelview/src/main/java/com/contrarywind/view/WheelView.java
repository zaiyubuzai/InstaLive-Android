...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            textColorOut = a.getColor(R.styleable.pickerview_wheelview_textColorOut, 0xFF898a8b);
    ...
    private String[] mouthE = {"January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"};
        ...
        while (counter < itemsVisible) {
            ...
            if (angle > 90F || angle < -90F) {
                ...
                if (!isCenterLabel && !TextUtils.isEmpty(label) && !TextUtils.isEmpty(getContentText(showText))) {
                    ...
                    if (isMouth) {
                        int indexs = Integer.parseInt(getContentText(showText));
                        indexs = indexs % 12 - 1;
                        if (indexs < 0) indexs = 11;
                        contentText = mouthE[indexs];
                    } else {
