 ...
 */
public class MarsUrlSignatureInterceptor implements Interceptor, HttpConstants {

    @NonNull
    protected final UrlSignatureConfig config;

    @Inject
    public MarsUrlSignatureInterceptor(@NonNull UrlSignatureConfig config) {
        this.config = config;
    }
    ...
    protected String signUrl(@NonNull String method,
        ...
        return UrlSignature.getInstance().signMarsUrl(config.getContext(), method, url, params, config.getTracker());
    }
