 ...
 */
public class UrlSignatureInterceptor implements Interceptor, HttpConstants {

    @NonNull
    protected final UrlSignatureConfig config;

    @Inject
    public UrlSignatureInterceptor(@NonNull UrlSignatureConfig config) {
        this.config = config;
    }
    ...
    protected String signUrl(@NonNull String method,
        ...
        return UrlSignature.getInstance().signUrl(config.getContext(), method, url, params, config.getTracker());
    }
