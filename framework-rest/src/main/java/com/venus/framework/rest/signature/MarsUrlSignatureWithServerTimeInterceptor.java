 ...
 */
public class MarsUrlSignatureWithServerTimeInterceptor extends MarsUrlSignatureInterceptor {
    ...
    @Inject
    public MarsUrlSignatureWithServerTimeInterceptor(@NonNull UrlSignatureConfig config,
